...
func newMulticastBroadcastClient(addressString string, dial dialer, sn string) (*multicastBroadcastClient, error) {
	...
	for _, addr := range addresses {
		conn, err := dial(addr, comm.ServerNameOverride(sn))
		if err != nil {
