...
func (e *Egress) SendConsensus(targetID uint64, m *smartbftprotos.Message) {
...
func bftMsgToClusterMsg(message *smartbftprotos.Message, channel string) *orderer.ConsensusRequest {
