...
func TestAssembler(t *testing.T) {
	...
	for _, testCase := range []struct {
		...
		},
		{
			...
			panicVal: "Programming error, received bad envelope but should have validated it: error unmarshaling Envelope: proto: common.Envelope: illegal tag 0 (wire type 1)",
			requests: [][]byte{{1, 2, 3}},
		},
		{
