...
func init() {
	ordererext.ConsensusTypeMetadataMap[TypeKey] = ConsensusTypeMetadataFactory{}
	ordererext.DecodeHooks[TypeKey] = append(ordererext.DecodeHooks[TypeKey], decodeConfig)
	ordererext.EncodeHooks[TypeKey] = append(ordererext.EncodeHooks[TypeKey], encodeConfig)
}
...
func (dogf ConsensusTypeMetadataFactory) NewMessage() proto.Message {
	return &smartbft.ConfigMetadata{}
}
...
func Marshal(md *smartbft.ConfigMetadata) ([]byte, error) {
