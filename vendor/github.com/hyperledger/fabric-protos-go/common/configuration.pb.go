...
// TimestampAccuracy is encoded into the configuration transaction as a
// configuration item of type Chain with a Key of "TimestampAccuracy" and a
// Value of TimestampAccuracy as marshaled protobuf bytes
...
func (m *TimestampAccuracy) Reset()         { *m = TimestampAccuracy{} }
func (m *TimestampAccuracy) String() string { return proto.CompactTextString(m) }
func (*TimestampAccuracy) ProtoMessage()    {}
func (*TimestampAccuracy) Descriptor() ([]byte, []int) {
	return fileDescriptor_cba1ec2883858369, []int{6}
}

func (m *TimestampAccuracy) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_TimestampAccuracy.Unmarshal(m, b)
}
func (m *TimestampAccuracy) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_TimestampAccuracy.Marshal(b, m, deterministic)
}
func (m *TimestampAccuracy) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TimestampAccuracy.Merge(m, src)
}
func (m *TimestampAccuracy) XXX_Size() int {
	return xxx_messageInfo_TimestampAccuracy.Size(m)
}
func (m *TimestampAccuracy) XXX_DiscardUnknown() {
	xxx_messageInfo_TimestampAccuracy.DiscardUnknown(m)
}

var xxx_messageInfo_TimestampAccuracy proto.InternalMessageInfo

func (m *TimestampAccuracy) GetAccuracy() string {
	if m != nil {
		return m.Accuracy
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*TimestampAccuracy)(nil), "common.TimestampAccuracy")
}
...
var fileDescriptor_cba1ec2883858369 = []byte{
	...
	,
}
